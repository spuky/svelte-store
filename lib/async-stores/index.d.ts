 ...
 */
export declare const asyncWritable: <S extends Stores, T>(stores: S, mappingLoadFunction: (values: StoresValues<S>) => T | Promise<T>, mappingWriteFunction?: (value: T, parentValues?: StoresValues<S>, oldValue?: T) => Promise<void | T>, options?: AsyncStoreOptions<T>) => WritableLoadable<T>;
/**
